...
import com.afeng.common.annotation.Delete;
import com.afeng.common.utils.ConvertUtils;
...
/**
 * 
 * @Description : 封装Hibernate原生API的DAO泛型基类.可在Service层直接使用, 也可以扩展泛型DAO子类使用, 见两个构造函数的注释.
