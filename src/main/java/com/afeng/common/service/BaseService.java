 ...
 */
package com.afeng.common.service;

import com.afeng.common.exception.DaoException;
import com.afeng.common.exception.ServiceException;
import com.afeng.common.exception.SystemException;
import com.afeng.common.dao.orm.HibernateDao;
import com.afeng.common.dao.orm.Page;
import com.afeng.common.dao.orm.Parameter;
import com.afeng.common.dao.orm.PropertyFilter;
import com.afeng.common.dao.orm.PropertyFilter.MatchType;
import com.afeng.common.entity.StatusState;
import com.afeng.common.utils.collections.Collections3;
...
/**
 * 
 * @Description : Service层领域对象业务管理类基类.使用HibernateDao<T,PK>进行业务对象的CRUD操作,子类需重载getEntityDao()函数提供该DAO.
 * @param <T>   : 领域对象类型
 * @param <PK>  : 领域对象的主键类型
 * @Date        : 2015-7-7
 * @author      : afeng  
